...
var moduleMap = {
	...
	"./home": function() {
		return __webpack_require__.e("realPages_index_js").then(function() { return function() { return (__webpack_require__(/*! ./realPages/index.js */ "./realPages/index.js")); }; });
	},
	"./pages-map": function() {
...
/*!***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** external "new Promise(function (resolve, reject) {\n    var url = new URL(\"http://localhost:3002/_next/static/chunks/remoteEntry.js\");\n    url.searchParams.set('t', Date.now());\n    var __webpack_error__ = new Error();\n    if (typeof shop !== 'undefined') return resolve();\n    __webpack_require__.l(\n      url.href,\n      function (event) {\n        if (typeof shop !== 'undefined') return resolve();\n        var errorType = event && (event.type === 'load' ? 'missing' : event.type);\n        var realSrc = event && event.target && event.target.src;\n        __webpack_error__.message =\n          'Loading script failed.\\n(' + errorType + ': ' + realSrc + ')';\n        __webpack_error__.name = 'ScriptExternalLoadError';\n        __webpack_error__.type = errorType;\n        __webpack_error__.request = realSrc;\n        reject(__webpack_error__);\n      },\n      \"shop\",\n    );\n  }).then(function () {\n    const proxy = {\n      get: shop.get,\n      init: function(shareScope) {\n\n        const handler = {\n          get(target, prop) {\n            if (target[prop]) {\n              Object.values(target[prop]).forEach(function(o) {\n                if(o.from === '_N_E') {\n                  o.loaded = 1\n                }\n              })\n            }\n            return target[prop]\n          },\n          set(target, property, value, receiver) {\n            if (target[property]) {\n              return target[property]\n            }\n            target[property] = value\n            return true\n          }\n        }\n        try {\n          shop.init(new Proxy(shareScope, handler))\n        } catch (e) {\n\n        }\n        shop.__initialized = true\n      }\n    }\n    if (!shop.__initialized) {\n      proxy.init(__webpack_require__.S.default)\n    }\n    return proxy\n  })" ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(module, __unused_webpack_exports, __webpack_require__) {
...
/******/ 			return "static/chunks/" + chunkId + "-" + {"components_nav_js":"63d90e0cfb61ede3","realPages_index_js":"2e796c2334bdf23c","pages-map_js":"cad8681bb4a913c0","webpack_container_remote_checkout_title":"21feac1be7b9695b"}[chunkId] + "-fed.js";
/******/ 		};
/******/ 	}();
/******/ 	
...
/******/ 			"webpack/sharing/consume/default/react": function() { return loadSingleton("default", "react"); },
/******/ 			"webpack/sharing/consume/default/styled-jsx/style": function() { return loadSingleton("default", "styled-jsx/style"); },
...
/******/ 			"webpack/sharing/consume/default/react-dom": function() { return loadSingleton("default", "react-dom"); },
/******/ 			"webpack/sharing/consume/default/next/router": function() { return loadSingleton("default", "next/router"); },
/******/ 			"webpack/sharing/consume/default/next/script": function() { return loadSingleton("default", "next/script"); },
/******/ 			"webpack/sharing/consume/default/styled-jsx": function() { return loadSingleton("default", "styled-jsx"); }
/******/ 		};
/******/ 		// no consumes in initial chunks
/******/ 		var chunkMapping = {
/******/ 			"components_nav_js": [
/******/ 				"webpack/sharing/consume/default/react",
/******/ 				"webpack/sharing/consume/default/styled-jsx/style",
...
/******/ 				"webpack/sharing/consume/default/next/link",
/******/ 				"webpack/sharing/consume/default/next/router",
/******/ 				"webpack/sharing/consume/default/next/head",
/******/ 				"webpack/sharing/consume/default/next/script",
/******/ 				"webpack/sharing/consume/default/next/dynamic",
/******/ 				"webpack/sharing/consume/default/styled-jsx",
/******/ 				"webpack/sharing/consume/default/styled-jsx/style"
/******/ 			]
/******/ 		};
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["homechunkLoader"] = self["homechunkLoader"] || [];
...
/******/ 	window.home = __webpack_exports__;
/******/ 	
/******/ })()
;